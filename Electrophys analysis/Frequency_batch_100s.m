...
for i = 1:number_of_files
   ...
   if filter == 0
        ...
        continue;
           ...
           [ISI_values, AP_actual_sizes, AP_times_number]=Analysis_100s(data((startts * filter + 1):(endts * filter)), 1, m, 9, filter, fullname, 'Frequency',path, filenames{1}, filenames(i) );
           m = m + 1;
