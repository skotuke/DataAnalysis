...
for i = 1:number_of_files
    ...
    for part=1:parts
        ...
        [ISI_values, AP_actual_sizes, AP_times_number,AP_sizes, AP_min_list]=Analysis(data((startts * filter + 1):(endts * filter)), 1, m, 9, filter, fullname, 'Frequency',path, filenames{1});
        m = m + 1;
    end
